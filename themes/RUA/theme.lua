...
local theme                                     = {}
theme.confdir                                   = os.getenv("HOME") .. "/.config/awesome/themes/RUA"
--theme.wallpaper                                 = os.getenv("HOME") .. "/Pictures/Wallpaper/1059936070.jpg"
theme.wp_dir                                    = os.getenv("HOME") .. "/Pictures/wp_sel/"
-- theme.wallpaper                                 = function(s) return theme.get_rand_wp(s) end
theme.wp_filter                                 = function(s) return string.match(s,"%.png$") or string.match(s,"%.jpg$") or string.match(s,"%.jpeg$") end
--theme.wallpapers                                = scan_dir(theme.wp_dir, theme.wp_filter)
...
function theme.wallpaper(s)
    local files = scan_dir(theme.wp_dir, theme.wp_filter)
    local wp_index = math.random(1, #files)
    --return theme.wp_dir .. files[wp_index]
    return theme.wp_dir .. files[wp_index]
end
...
local mytextclock = wibox.widget.textclock(markup("#7788af", "%B %d %A ") .. markup("#de5e1e", " %H:%M "))
...
function theme.at_screen_connect(s)
	...
	-- 	  buttoms = awful.util.tasklist_buttons,
	-- 	  widget_template =
	-- 		 {
	-- 			{
	-- 			   {
